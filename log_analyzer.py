...
cl_to_plot_id = 0 # Target class, typically the low frequent one
...
if 'elliptic' in filename or 'reddit' in filename or ('bitcoin' in filename and 'edge' in filename) or 'sybil' in filename:
...
str_results+=filename.split('.log')[0]
str_legend+='log_file'
print ('\n\nCSV-like output:')
print (str_legend)
print (str_results)
